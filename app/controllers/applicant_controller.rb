...
class ApplicantController < ApplicationController
  ...
  def index
    ...
    @registrations = @applicant.registrations.select { |registration| registration.jobfair.date > Time.now.to_date }
  ...
  def create
    ...
    flash[:notice] = "Your account has been created and an email has been sent to your email address.  Please click the activation link in the email's body."
...
# Commented to render applicant/apply.js
